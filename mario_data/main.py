...
class Main():
    ...
    def __init__(self):
        ...
        self.time = Digit_System(Vector2(610, 49), 3, 500) #Displays time on screen
    ...
    def update_level(self, shared_array):
        """Update all Gameobjects in the level"""
        c.mario.update(shared_array)
